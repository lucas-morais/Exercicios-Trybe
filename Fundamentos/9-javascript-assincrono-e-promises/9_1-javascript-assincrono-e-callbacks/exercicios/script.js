...
const sendMarsTemperature = () => {
  ...
  setTimeout(() => console.log(`Mars temperature is ${temperature} deegre Celsius`), messageDelay());
}

sendMarsTemperature(); // imprime "Mars temperature is: 20 degree Celsius", por exemplo

// 7.
const secondMessageDelay = () => Math.floor(Math.random() * 5000);
...
const sendMarsTemperatureWithCallback = (callback) => {
  const temperature = getMarsTemperature()
  setTimeout(() => callback(temperature), secondMessageDelay);
}
